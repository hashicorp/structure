...
export const VALID_BUTTON_LIKE = ['button', 'reset', 'submit'];
...
export const VALID_NON_TEXT_LIKE = [...VALID_BUTTON_LIKE, ...VALID_OTHER];

export const VALID = [...VALID_TEXT_LIKE, ...VALID_NON_TEXT_LIKE];
