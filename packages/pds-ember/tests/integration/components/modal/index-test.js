...
module('Integration | Components.Modal', function (hooks) {
  ...
  test('it renders', async function (assert) {
    ...
    assert.dom(TITLE).exists().hasText('title');
    ...
    assert.dom(ROOT).hasClass('pds-modal--plain');
    assert
      .dom(ICON)
      .exists()
      .hasAttribute(
    ...
    assert.dom(ROOT).hasClass('pds-modal--error');
    assert
      .dom(ICON)
      .exists()
      .hasAttribute(
    ...
    assert.dom(ROOT).hasClass('pds-modal--info');
    assert
      .dom(ICON)
      .exists()
      .hasAttribute(
    ...
    assert.dom(ROOT).hasClass('pds-modal--success');
    assert
      .dom(ICON)
      .exists()
      .hasAttribute(
    ...
    assert.dom(ROOT).hasClass('pds-modal--warning');
    assert
      .dom(ICON)
      .exists()
      .hasAttribute(
