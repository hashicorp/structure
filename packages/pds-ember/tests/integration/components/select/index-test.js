...
module('Integration | Components.Select', function(hooks) {
  ...
  test('it renders with grouped options as block content', async function(assert) {
    ...
    // first <optgroup>
    assert.dom('optgroup:nth-child(1) option:nth-of-type(1)').hasProperty('selected', false)
    assert.dom('optgroup:nth-child(1) option:nth-of-type(2)').hasProperty('selected', false)
    assert.dom('optgroup:nth-child(1) option:nth-of-type(3)').hasProperty('selected', false)
    // second <optgroup>
    assert.dom('optgroup:nth-child(2) option:nth-of-type(1)').hasProperty('selected', false)
    assert.dom('optgroup:nth-child(2) option:nth-of-type(2)').hasProperty('selected', true)
    assert.dom('optgroup:nth-child(2) option:nth-of-type(3)').hasProperty('selected', false)
  })
})
